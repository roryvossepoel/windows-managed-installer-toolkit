...
The current stable toolkit version is **1.0.0**. The ADMX configuration and Intune detection/remediation workflow have been validated on managed Windows devices. See [CHANGELOG.md](CHANGELOG.md) for release notes and use the downloadable distribution ZIP from the GitHub release or repository.
