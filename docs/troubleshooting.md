...
The scripts reject a globally enabled configuration with no enabled preset or custom slot. Enable at least one rule in the same profile, or set global management to Disabled for intentional cleanup.
